...
public:
    ...
    typedef Zen::Memory::managed_weak_ptr<I_ScriptObject>   wpScriptObject_type;
...
namespace Memory {
    // I_ScriptObject is managed by I_ObjectReference
    template<>
    struct is_managed_by_factory<Scripting::I_ScriptObject> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
