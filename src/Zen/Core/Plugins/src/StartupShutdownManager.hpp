...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_PLUGINS_STARTUP_SHUTDOWN_MANAGER_HPP_INCLUDED
#define ZEN_PLUGINS_STARTUP_SHUTDOWN_MANAGER_HPP_INCLUDED
...
#endif // ZEN_PLUGINS_STARTUP_SHUTDOWN_MANAGER_HPP_INCLUDED
