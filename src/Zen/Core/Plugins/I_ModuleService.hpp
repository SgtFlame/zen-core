...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_PLUGINS_I_MODULE_SERVICE_HPP_INCLUDED
#define ZEN_PLUGINS_I_MODULE_SERVICE_HPP_INCLUDED
...
class PLUGINS_DLL_LINK I_ModuleService
...
#endif // ZEN_PLUGINS_I_MODULE_SERVICE_HPP_INCLUDED
