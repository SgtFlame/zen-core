...
#ifndef ZEN_THREADING_MUTEX_FACTORY_HPP_INCLUDED
#define ZEN_THREADING_MUTEX_FACTORY_HPP_INCLUDED
...
class THREADING_DLL_LINK MutexFactory
{
    /// @name Types
    /// @{
public:
...
#endif // ZEN_THREADING_MUTEX_FACTORY_HPP_INCLUDED
